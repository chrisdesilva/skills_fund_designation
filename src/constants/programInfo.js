import logo from "../images/designation_logo.png" // add school logo to images folder and import here
...
export const schoolName = "Designation"

export const schoolURL =
  "https://flatironschool.com/career-courses/ux-ui-design-bootcamp/chicago" // update with url of school's website

export const skfURL = "https://designation.skills.fund" // update with Skills Fund url

export const headline = "Learn UX/UI Design At Designation" // update headline as appropriate
...
export const programLoanInfo = [
  ...
  {
    name: "UX Design",
    url: "https://my.skills.fund/application?lenderCode=SFD17",
    loanInfo: {
