...
const LoanApp = React.forwardRef((props, ref) => {
	...
	const [ loanUrl, setLoanUrl ] = useState(`https://my.skills.fund/application?lenderCode=SFD17`); // if multiple programs, set lenderCode to first program option
	...
	const handleProgramSelect = (programNumber) => {
		switch (programNumber) {
			case 1: // info should match default
				...
				setLoanUrl(`https://my.skills.fund/application?lenderCode=SFD17`); // update lenderCode with market segment code from LP
				break;
			default:
				...
				setLoanUrl(`https://my.skills.fund/application?lenderCode=SFD17`);
				break;
		}
	};
	...
	return (
		...
		>
			...
			<div className="rounded shadow-2xl pt-8 px-8 mx-4 bg-white">
				...
				<form
					className="designation_apply_now program-apply flex flex-col items-center"
			...
			<div className="px-8 text-sm">
				{/* <p className="text-center pt-8">
					...
					<a
						...
						href="https://sf.privateloan.studentloan.org/Cosigner.do?execution=e1s1"
