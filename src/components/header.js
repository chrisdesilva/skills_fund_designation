...
import schoolLogo from "../images/designation_logo.png" // add school logo to images folder and import here
...
const schoolInfo = {
  ...
  schoolUrl: 'https://designation.io/' // update with url of school's website
}
